...
namespace GeneXus.Programs {
   public class viewlugar : GXDataArea
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("LugarNombre", StringUtil.RTrim( context.localUtil.Format( A9LugarNombre, "")));
      ...
      protected void WB080( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtLugarNombre_Internalname, A9LugarNombre, StringUtil.RTrim( context.localUtil.Format( A9LugarNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLugarNombre_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtLugarNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_ViewLugar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablesector_Internalname, 1, 0, "px", 0, "px", "ww__view__tab__form-container", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0034"+"", StringUtil.RTrim( WebComp_Sectorwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblEvento_title_Internalname, "Evento", "", "", lblEvento_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewLugar.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0042"+"", StringUtil.RTrim( WebComp_Eventowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 34 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Sectorwc_Component) != 0 )
                           {
                              WebComp_Sectorwc.componentprocess("W0034", "", sEvt);
                           }
                           WebComp_Sectorwc_Component = OldSectorwc;
                        }
                        else if ( nCmpId == 42 )
                        {
                           OldEventowc = cgiGet( "W0042");
                           ...
                           if ( StringUtil.Len( WebComp_Eventowc_Component) != 0 )
                           {
                              WebComp_Eventowc.componentprocess("W0042", "", sEvt);
                           }
                           WebComp_Eventowc_Component = OldEventowc;
                        }
                     }
      ...
      protected void RF082( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A4LugarId = H00082_A4LugarId[0];
               A9LugarNombre = H00082_A9LugarNombre[0];
      ...
      protected void E11082( )
      {
         ...
         {
            A4LugarId = H00083_A4LugarId[0];
            A9LugarNombre = H00083_A9LugarNombre[0];
            AssignAttri("", false, "A9LugarNombre", A9LugarNombre);
            AV14GXLvl7 = 1;
            Form.Caption = A9LugarNombre;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Sector") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Sectorwc_Component) != 0 )
            {
               ...
               WebComp_Sectorwc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12LugarId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Evento") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Eventowc_Component), StringUtil.Lower( "LugarEventoWC")) != 0 )
            {
               WebComp_Eventowc = getWebComponent(GetType(), "GeneXus.Programs", "lugareventowc", new Object[] {context} );
               WebComp_Eventowc.ComponentInit();
               WebComp_Eventowc.Name = "LugarEventoWC";
               WebComp_Eventowc_Component = "LugarEventoWC";
            }
            if ( StringUtil.Len( WebComp_Eventowc_Component) != 0 )
            {
               WebComp_Eventowc.setjustcreated();
               WebComp_Eventowc.componentprepare(new Object[] {(string)"W0042",(string)"",(short)AV12LugarId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219513520", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewlugar.js", "?202481219513520", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12LugarId","fld":"vLUGARID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A9LugarNombre","fld":"LUGARNOMBRE"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H00082_A4LugarId = new short[1] ;
         H00082_A9LugarNombre = new string[] {""} ;
         hsh = "";
         H00083_A4LugarId = new short[1] ;
         H00083_A9LugarNombre = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewlugar__default(),
            new Object[][] {
                new Object[] {
               H00082_A4LugarId, H00082_A9LugarNombre
               }
               , new Object[] {
               H00083_A4LugarId, H00083_A9LugarNombre
               }
            }
         );
      ...
      private short[] H00082_A4LugarId ;
      private string[] H00082_A9LugarNombre ;
      private short[] H00083_A4LugarId ;
      private string[] H00083_A9LugarNombre ;
