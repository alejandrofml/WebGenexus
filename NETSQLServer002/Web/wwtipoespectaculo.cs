...
namespace GeneXus.Programs {
   public class wwtipoespectaculo : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11TipoEspectaculoNombre = GetPar( "TipoEspectaculoNombre");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11TipoEspectaculoNombre, AV12Update, AV13Delete) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vTIPOESPECTACULONOMBRE", AV11TipoEspectaculoNombre);
         /* Send saved values. */
      ...
      protected void WB0I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divGridcell_Internalname, 1, 0, "px", 0, "px", "col-xs-12 ww__grid-cell", "Center", "top", "", "", "div");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Tipo de Espectáculo", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWTipoEspectaculo.htm");
            ...
            GxWebStd.gx_label_element( context, edtavTipoespectaculonombre_Internalname, "Tipo Espectaculo Nombre", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTipoespectaculonombre_Internalname, AV11TipoEspectaculoNombre, StringUtil.RTrim( context.localUtil.Format( AV11TipoEspectaculoNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Espectaculo Nombre", edtavTipoespectaculonombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavTipoespectaculonombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWTipoEspectaculo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 27 )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttImprimirlistadoportipo_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Imprimir Listado por Tipo", bttImprimirlistadoportipo_Jsonclick, 7, "Imprimir Listado por Tipo", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110i1_client"+"'", TempTags, "", 2, "HLP_WWTipoEspectaculo.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttConciertoporfecha_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Concierto por fecha", bttConciertoporfecha_Jsonclick, 7, "Concierto por fecha", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e120i1_client"+"'", TempTags, "", 2, "HLP_WWTipoEspectaculo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttVolver_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Volver", bttVolver_Jsonclick, 7, "Volver", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e130i1_client"+"'", TempTags, "", 2, "HLP_WWTipoEspectaculo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Tipoespectaculonombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vTIPOESPECTACULONOMBRE"), AV11TipoEspectaculoNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0I2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavTipoespectaculonombre_Internalname;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       string AV11TipoEspectaculoNombre ,
                                       string AV12Update ,
                                       string AV13Delete )
      {
         initialize_formulas( ) ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_TIPOESPECTACULOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A2TipoEspectaculoId), "ZZZ9"), context));
      ...
      protected void RF0I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11TipoEspectaculoNombre = StringUtil.Concat( StringUtil.RTrim( AV11TipoEspectaculoNombre), "%", "");
            /* Using cursor H000I2 */
            pr_default.execute(0, new Object[] {lV11TipoEspectaculoNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A12TipoEspectaculoNombre = H000I2_A12TipoEspectaculoNombre[0];
               A2TipoEspectaculoId = H000I2_A2TipoEspectaculoId[0];
               /* Execute user event: Grid.Load */
               E170I2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_TIPOESPECTACULOID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A2TipoEspectaculoId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11TipoEspectaculoNombre = StringUtil.Concat( StringUtil.RTrim( AV11TipoEspectaculoNombre), "%", "");
         /* Using cursor H000I3 */
         pr_default.execute(1, new Object[] {lV11TipoEspectaculoNombre});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11TipoEspectaculoNombre = GridState.FilterValues("Tipoespectaculonombre");
            AssignAttri("", false, "AV11TipoEspectaculoNombre", AV11TipoEspectaculoNombre);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("TipoEspectaculoNombre", AV11TipoEspectaculoNombre);
      }
      ...
      protected void STRUP0I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11TipoEspectaculoNombre = cgiGet( edtavTipoespectaculonombre_Internalname);
            AssignAttri("", false, "AV11TipoEspectaculoNombre", AV11TipoEspectaculoNombre);
      ...
      private void E170I2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("tipoespectaculo.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A2TipoEspectaculoId,4,0))}, new string[] {"Mode","TipoEspectaculoId"}) ;
         edtavDelete_Link = formatLink("tipoespectaculo.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A2TipoEspectaculoId,4,0))}, new string[] {"Mode","TipoEspectaculoId"}) ;
         edtTipoEspectaculoNombre_Link = formatLink("viewtipoespectaculo.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A2TipoEspectaculoId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"TipoEspectaculoId","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 27;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219513895", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwtipoespectaculo.js", "?202481219513896", false, true);
         }
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtTipoEspectaculoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A2TipoEspectaculoId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A2TipoEspectaculoId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtTipoEspectaculoId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A2TipoEspectaculoId), 4, 0, ".", ""))));
      ...
      protected void init_default_properties( )
      {
         ...
         bttImprimirlistadoportipo_Internalname = "IMPRIMIRLISTADOPORTIPO";
         bttConciertoporfecha_Internalname = "CONCIERTOPORFECHA";
      ...
      public override void initialize_properties( )
      {
         ...
         edtTipoEspectaculoNombre_Enabled = 0;
         edtTipoEspectaculoId_Enabled = 0;
         edtavTipoespectaculonombre_Jsonclick = "";
         edtavTipoespectaculonombre_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11TipoEspectaculoNombre","fld":"vTIPOESPECTACULONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("'VOLVER'","""{"handler":"E130I1","iparms":[]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E170I2","iparms":[{"av":"A2TipoEspectaculoId","fld":"TIPOESPECTACULOID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtTipoEspectaculoNombre_Link","ctrl":"TIPOESPECTACULONOMBRE","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E140I2","iparms":[{"av":"A2TipoEspectaculoId","fld":"TIPOESPECTACULOID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("'IMPRIMIR LISTADO POR TIPO'","""{"handler":"E110I1","iparms":[]}""");
         setEventMetadata("'CONCIERTO POR FECHA'","""{"handler":"E120I1","iparms":[]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11TipoEspectaculoNombre","fld":"vTIPOESPECTACULONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11TipoEspectaculoNombre","fld":"vTIPOESPECTACULONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11TipoEspectaculoNombre","fld":"vTIPOESPECTACULONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11TipoEspectaculoNombre","fld":"vTIPOESPECTACULONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         GridContainer = new GXWebGrid( context);
         sStyleString = "";
         bttImprimirlistadoportipo_Jsonclick = "";
         bttConciertoporfecha_Jsonclick = "";
         bttVolver_Jsonclick = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         ...
         lV11TipoEspectaculoNombre = "";
         H000I2_A12TipoEspectaculoNombre = new string[] {""} ;
         H000I2_A2TipoEspectaculoId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwtipoespectaculo__default(),
            new Object[][] {
                new Object[] {
               H000I2_A12TipoEspectaculoNombre, H000I2_A2TipoEspectaculoId
               }
               , new Object[] {
      ...
      private string bttImprimirlistadoportipo_Internalname ;
      private string bttImprimirlistadoportipo_Jsonclick ;
      private string bttConciertoporfecha_Internalname ;
      private string bttConciertoporfecha_Jsonclick ;
      ...
      private string lV11TipoEspectaculoNombre ;
      ...
      private string[] H000I2_A12TipoEspectaculoNombre ;
      private short[] H000I2_A2TipoEspectaculoId ;
   ...
   public class wwtipoespectaculo__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000I2( IGxContext context ,
                                             string AV11TipoEspectaculoNombre ,
                                             string A12TipoEspectaculoNombre )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [TipoEspectaculoNombre], [TipoEspectaculoId]";
         sFromString = " FROM [TipoEspectaculo]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11TipoEspectaculoNombre)) )
         {
            AddWhere(sWhereString, "([TipoEspectaculoNombre] like @lV11TipoEspectaculoNombre)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [TipoEspectaculoNombre]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11TipoEspectaculoNombre",GXType.NVarChar,100,0) ,
