...
namespace GeneXus.Programs {
   public class wwlugar : GXDataArea
   {
      ...
      protected void gxnrGrid_newrow_invoke( )
      {
         ...
         AV16Update = GetPar( "Update");
         AV7Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11LugarNombre = GetPar( "LugarNombre");
         AV16Update = GetPar( "Update");
         AV7Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11LugarNombre, AV16Update, AV7Delete) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vLUGARNOMBRE", AV11LugarNombre);
         /* Send saved values. */
      ...
      protected void WB0F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWLugar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavLugarnombre_Internalname, AV11LugarNombre, StringUtil.RTrim( context.localUtil.Format( AV11LugarNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavLugarnombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavLugarnombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWLugar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 27 )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttVolver_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Volver", bttVolver_Jsonclick, 7, "Volver", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110f1_client"+"'", TempTags, "", 2, "HLP_WWLugar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 16), "'LISTADOPORTIPO'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignAttri("", false, edtavDelete_Internalname, AV7Delete);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "'LISTADOPORTIPO'") == 0 )
                                 {
                                    context.wbHandled = 1;
                                    dynload_actions( ) ;
                                    /* Execute user event: 'ListadoPorTipo' */
                                    E160F2 ();
                                 }
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vLUGARNOMBRE"), AV11LugarNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void RF0F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11LugarNombre = StringUtil.Concat( StringUtil.RTrim( AV11LugarNombre), "%", "");
            /* Using cursor H000F3 */
            pr_default.execute(0, new Object[] {lV11LugarNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A7PaisId = H000F3_A7PaisId[0];
               A13LugarDireccion = H000F3_A13LugarDireccion[0];
               A9LugarNombre = H000F3_A9LugarNombre[0];
               A4LugarId = H000F3_A4LugarId[0];
               A22TotalEspectaculos = H000F3_A22TotalEspectaculos[0];
               n22TotalEspectaculos = H000F3_n22TotalEspectaculos[0];
               A22TotalEspectaculos = H000F3_A22TotalEspectaculos[0];
               n22TotalEspectaculos = H000F3_n22TotalEspectaculos[0];
               /* Execute user event: Grid.Load */
               E150F2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_LUGARID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A4LugarId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11LugarNombre = StringUtil.Concat( StringUtil.RTrim( AV11LugarNombre), "%", "");
         /* Using cursor H000F5 */
         pr_default.execute(1, new Object[] {lV11LugarNombre});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11LugarNombre = GridState.FilterValues("Lugarnombre");
            AssignAttri("", false, "AV11LugarNombre", AV11LugarNombre);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("LugarNombre", AV11LugarNombre);
      }
      ...
      protected void STRUP0F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11LugarNombre = cgiGet( edtavLugarnombre_Internalname);
            AssignAttri("", false, "AV11LugarNombre", AV11LugarNombre);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV14TrnContext = new GeneXus.Programs.general.ui.SdtTransactionContext(context);
         AV14TrnContext.gxTpr_Callerobject = AV17Pgmname;
         AV14TrnContext.gxTpr_Callerondelete = true;
         AV14TrnContext.gxTpr_Callerurl = AV9HTTPRequest.ScriptName+"?"+AV9HTTPRequest.QueryString;
         AV14TrnContext.gxTpr_Transactionname = "Lugar";
         AV12Session.Set("TrnContext", AV14TrnContext.ToXml(false, true, "", ""));
      }

      protected void E160F2( )
      {
         /* 'ListadoPorTipo' Routine */
         returnInSub = false;
         CallWebObject(formatLink("alistadoespectaculosportipo.aspx") );
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219513632", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwlugar.js", "?202481219513632", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtTotalEspectaculos_Internalname = "TOTALESPECTACULOS_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtTotalEspectaculos_Internalname = "TOTALESPECTACULOS_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtTotalEspectaculos_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A22TotalEspectaculos), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A22TotalEspectaculos), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtTotalEspectaculos_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Total Espectaculos") ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV16Update)));
            GridColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavUpdate_Enabled), 5, 0, ".", "")));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtavUpdate_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV7Delete)));
      ...
      protected void init_default_properties( )
      {
         ...
         edtTotalEspectaculos_Internalname = "TOTALESPECTACULOS";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11LugarNombre","fld":"vLUGARNOMBRE"},{"av":"AV16Update","fld":"vUPDATE"},{"av":"AV7Delete","fld":"vDELETE"}]}""");
         setEventMetadata("'VOLVER'","""{"handler":"E110F1","iparms":[]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E150F2","iparms":[{"av":"A4LugarId","fld":"LUGARID","pic":"ZZZ9","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E120F2","iparms":[{"av":"A4LugarId","fld":"LUGARID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("'LISTADOPORTIPO'","""{"handler":"E160F2","iparms":[]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11LugarNombre","fld":"vLUGARNOMBRE"},{"av":"AV16Update","fld":"vUPDATE"},{"av":"AV7Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11LugarNombre","fld":"vLUGARNOMBRE"},{"av":"AV16Update","fld":"vUPDATE"},{"av":"AV7Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11LugarNombre","fld":"vLUGARNOMBRE"},{"av":"AV16Update","fld":"vUPDATE"},{"av":"AV7Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11LugarNombre","fld":"vLUGARNOMBRE"},{"av":"AV16Update","fld":"vUPDATE"},{"av":"AV7Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11LugarNombre = "";
         H000F3_A7PaisId = new short[1] ;
         H000F3_A13LugarDireccion = new string[] {""} ;
         H000F3_A9LugarNombre = new string[] {""} ;
         H000F3_A4LugarId = new short[1] ;
         H000F3_A22TotalEspectaculos = new short[1] ;
         H000F3_n22TotalEspectaculos = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwlugar__default(),
            new Object[][] {
                new Object[] {
               H000F3_A7PaisId, H000F3_A13LugarDireccion, H000F3_A9LugarNombre, H000F3_A4LugarId, H000F3_A22TotalEspectaculos, H000F3_n22TotalEspectaculos
               }
               , new Object[] {
      ...
      private string AV11LugarNombre ;
      private string A9LugarNombre ;
      private string A13LugarDireccion ;
      private string lV11LugarNombre ;
      ...
      private short[] H000F3_A7PaisId ;
      private string[] H000F3_A13LugarDireccion ;
      private string[] H000F3_A9LugarNombre ;
      private short[] H000F3_A4LugarId ;
      private short[] H000F3_A22TotalEspectaculos ;
      private bool[] H000F3_n22TotalEspectaculos ;
      private long[] H000F5_AGRID_nRecordCount ;
      private GeneXus.Programs.general.ui.SdtTransactionContext AV14TrnContext ;
   ...
   public class wwlugar__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A9LugarNombre )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[PaisId], T1.[LugarDireccion], T1.[LugarNombre], T1.[LugarId], COALESCE( T2.[TotalEspectaculos], 0) AS TotalEspectaculos";
         sFromString = " FROM ([Lugar] T1 LEFT JOIN (SELECT COUNT(*) AS TotalEspectaculos, [LugarId] FROM [Evento] GROUP BY [LugarId] ) T2 ON T2.[LugarId] = T1.[LugarId])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11LugarNombre)) )
         {
            AddWhere(sWhereString, "(T1.[LugarNombre] like @lV11LugarNombre)");
         }
         else
         {
            GXv_int1[0] = 1;
                                             ...
                                             string A9LugarNombre )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([Lugar] T1 LEFT JOIN (SELECT COUNT(*) AS TotalEspectaculos, [LugarId] FROM [Evento] GROUP BY [LugarId] ) T2 ON T2.[LugarId] = T1.[LugarId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11LugarNombre)) )
         {
            AddWhere(sWhereString, "(T1.[LugarNombre] like @lV11LugarNombre)");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11LugarNombre",GXType.NVarChar,100,0) ,
