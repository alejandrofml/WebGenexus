   ...
   public class wwpais : GXDataArea
   {
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "País", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWPais.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavPaisnombre_Internalname, AV11PaisNombre, StringUtil.RTrim( context.localUtil.Format( AV11PaisNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavPaisnombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavPaisnombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWPais.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 27 )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttVolver_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Volver", bttVolver_Jsonclick, 7, "Volver", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110h1_client"+"'", TempTags, "", 2, "HLP_WWPais.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0H2( )
      {
         ...
         Form.Meta.addItem("description", "Work With Pais", 0) ;
         context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PAISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A7PaisId), "ZZZ9"), context));
      ...
      protected void RF0H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A11PaisNombre = H000H2_A11PaisNombre[0];
               A7PaisId = H000H2_A7PaisId[0];
               /* Execute user event: Grid.Load */
               E150H2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PAISID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A7PaisId), "ZZZ9"), context));
      }
      ...
      private void E150H2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("pais.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A7PaisId,4,0))}, new string[] {"Mode","PaisId"}) ;
         edtavDelete_Link = formatLink("pais.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A7PaisId,4,0))}, new string[] {"Mode","PaisId"}) ;
         edtPaisNombre_Link = formatLink("viewpais.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A7PaisId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"PaisId","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 27;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219513630", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpais.js", "?202481219513631", false, true);
         }
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A7PaisId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A7PaisId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPaisId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A7PaisId), 4, 0, ".", ""))));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E150H2","iparms":[{"av":"A7PaisId","fld":"PAISID","pic":"ZZZ9","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E120H2","iparms":[{"av":"A7PaisId","fld":"PAISID","pic":"ZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11PaisNombre = "";
         H000H2_A11PaisNombre = new string[] {""} ;
         H000H2_A7PaisId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpais__default(),
            new Object[][] {
                new Object[] {
               H000H2_A11PaisNombre, H000H2_A7PaisId
               }
               , new Object[] {
      ...
      private string[] H000H2_A11PaisNombre ;
      private short[] H000H2_A7PaisId ;
   ...
   public class wwpais__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11PaisNombre",GXType.NVarChar,100,0) ,
