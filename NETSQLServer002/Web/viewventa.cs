...
namespace GeneXus.Programs {
   public class viewventa : GXDataArea
   {
      public viewventa( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12VentaId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
      ...
      protected void WB0C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Ventas", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewVenta.htm");
            ...
            GxWebStd.gx_label_element( context, edtVentaHoraFecha_Internalname, "Hora Fecha", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtVentaHoraFecha_Internalname, context.localUtil.TToC( A23VentaHoraFecha, 10, 8, 1, 2, "/", ":", " "), context.localUtil.Format( A23VentaHoraFecha, "99/99/99 99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'MDY',5,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'MDY',5,12,'eng',false,0);"+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVentaHoraFecha_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtVentaHoraFecha_Enabled, 0, "text", "", 17, "chr", 1, "row", 17, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_ViewVenta.htm");
            GxWebStd.gx_bitmap( context, edtVentaHoraFecha_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtVentaHoraFecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewVenta.htm");
      ...
      protected void RF0C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A8VentaId = H000C2_A8VentaId[0];
               A23VentaHoraFecha = H000C2_A23VentaHoraFecha[0];
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtVentaHoraFecha_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtVentaHoraFecha_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP0C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12VentaId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vVENTAID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E110C2( )
      {
         ...
         {
            A8VentaId = H000C3_A8VentaId[0];
            A23VentaHoraFecha = H000C3_A23VentaHoraFecha[0];
            AssignAttri("", false, "A23VentaHoraFecha", context.localUtil.TToC( A23VentaHoraFecha, 8, 5, 1, 2, "/", ":", " "));
            AV14GXLvl7 = 1;
            Form.Caption = context.localUtil.TToC( A23VentaHoraFecha, 8, 5, 1, 2, "/", ":", " ");
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12VentaId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219513592", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewventa.js", "?202481219513592", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12VentaId","fld":"vVENTAID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A23VentaHoraFecha","fld":"VENTAHORAFECHA","pic":"99/99/99 99:99"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H000C2_A8VentaId = new short[1] ;
         H000C2_A23VentaHoraFecha = new DateTime[] {DateTime.MinValue} ;
         hsh = "";
         H000C3_A8VentaId = new short[1] ;
         H000C3_A23VentaHoraFecha = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewventa__default(),
            new Object[][] {
                new Object[] {
               H000C2_A8VentaId, H000C2_A23VentaHoraFecha
               }
               , new Object[] {
               H000C3_A8VentaId, H000C3_A23VentaHoraFecha
               }
            }
         );
      ...
      private short[] H000C2_A8VentaId ;
      private DateTime[] H000C2_A23VentaHoraFecha ;
      private short[] H000C3_A8VentaId ;
      private DateTime[] H000C3_A23VentaHoraFecha ;
   ...
   public class viewventa__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000C2", "SELECT [VentaId], [VentaHoraFecha] FROM [Venta] WHERE [VentaId] = @AV12VentaId ORDER BY [VentaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000C3", "SELECT [VentaId], [VentaHoraFecha] FROM [Venta] WHERE [VentaId] = @AV12VentaId ORDER BY [VentaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
