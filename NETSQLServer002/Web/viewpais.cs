...
namespace GeneXus.Programs {
   public class viewpais : GXDataArea
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("PaisNombre", StringUtil.RTrim( context.localUtil.Format( A11PaisNombre, "")));
      ...
      protected void WB090( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "País", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewPais.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtPaisNombre_Internalname, A11PaisNombre, StringUtil.RTrim( context.localUtil.Format( A11PaisNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisNombre_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtPaisNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_ViewPais.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF092( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A7PaisId = H00092_A7PaisId[0];
               A11PaisNombre = H00092_A11PaisNombre[0];
      ...
      protected void E11092( )
      {
         ...
         {
            A7PaisId = H00093_A7PaisId[0];
            A11PaisNombre = H00093_A11PaisNombre[0];
            AssignAttri("", false, "A11PaisNombre", A11PaisNombre);
            AV14GXLvl7 = 1;
            Form.Caption = A11PaisNombre;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219513519", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewpais.js", "?202481219513519", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12PaisId","fld":"vPAISID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A11PaisNombre","fld":"PAISNOMBRE"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H00092_A7PaisId = new short[1] ;
         H00092_A11PaisNombre = new string[] {""} ;
         hsh = "";
         H00093_A7PaisId = new short[1] ;
         H00093_A11PaisNombre = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewpais__default(),
            new Object[][] {
                new Object[] {
               H00092_A7PaisId, H00092_A11PaisNombre
               }
               , new Object[] {
               H00093_A7PaisId, H00093_A11PaisNombre
               }
            }
         );
      ...
      private short[] H00092_A7PaisId ;
      private string[] H00092_A11PaisNombre ;
      private short[] H00093_A7PaisId ;
      private string[] H00093_A11PaisNombre ;
   ...
   public class viewpais__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00092", "SELECT [PaisId], [PaisNombre] FROM [Pais] WHERE [PaisId] = @AV12PaisId ORDER BY [PaisId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00092,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00093", "SELECT [PaisId], [PaisNombre] FROM [Pais] WHERE [PaisId] = @AV12PaisId ORDER BY [PaisId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00093,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
