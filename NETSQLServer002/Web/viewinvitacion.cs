...
namespace GeneXus.Programs {
   public class viewinvitacion : GXDataArea
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("InvitacionNominada", StringUtil.BoolToStr( A19InvitacionNominada));
      ...
      protected void WB070( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, chkInvitacionNominada_Internalname, "Nominada", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"";
            ClassString = "heading-01";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkInvitacionNominada_Internalname, StringUtil.BoolToStr( A19InvitacionNominada), "", "Nominada", 1, chkInvitacionNominada.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(15, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,15);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF072( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A6InvitacionId = H00072_A6InvitacionId[0];
               A19InvitacionNominada = H00072_A19InvitacionNominada[0];
               AssignAttri("", false, "A19InvitacionNominada", A19InvitacionNominada);
               /* Execute user event: Load */
               E12072 ();
      ...
      protected void E11072( )
      {
         ...
         {
            A6InvitacionId = H00073_A6InvitacionId[0];
            A19InvitacionNominada = H00073_A19InvitacionNominada[0];
            AssignAttri("", false, "A19InvitacionNominada", A19InvitacionNominada);
            AV14GXLvl7 = 1;
            Form.Caption = StringUtil.BoolToStr( A19InvitacionNominada);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219513487", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewinvitacion.js", "?202481219513487", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12InvitacionId","fld":"vINVITACIONID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A19InvitacionNominada","fld":"INVITACIONNOMINADA"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H00072_A6InvitacionId = new short[1] ;
         H00072_A19InvitacionNominada = new bool[] {false} ;
         hsh = "";
         H00073_A6InvitacionId = new short[1] ;
         H00073_A19InvitacionNominada = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewinvitacion__default(),
            new Object[][] {
                new Object[] {
               H00072_A6InvitacionId, H00072_A19InvitacionNominada
               }
               , new Object[] {
               H00073_A6InvitacionId, H00073_A19InvitacionNominada
               }
            }
         );
      ...
      private short[] H00072_A6InvitacionId ;
      private bool[] H00072_A19InvitacionNominada ;
      private short[] H00073_A6InvitacionId ;
      private bool[] H00073_A19InvitacionNominada ;
   ...
   public class viewinvitacion__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00072", "SELECT [InvitacionId], [InvitacionNominada] FROM [Invitacion] WHERE [InvitacionId] = @AV12InvitacionId ORDER BY [InvitacionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00072,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00073", "SELECT [InvitacionId], [InvitacionNominada] FROM [Invitacion] WHERE [InvitacionId] = @AV12InvitacionId ORDER BY [InvitacionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00073,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
