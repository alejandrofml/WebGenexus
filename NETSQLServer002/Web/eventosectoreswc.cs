...
namespace GeneXus.Programs {
   public class eventosectoreswc : GXWebComponent
   {
      public eventosectoreswc( )
      {
      ...
      public eventosectoreswc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6EventoId = (short)(Math.Round(NumberUtil.Val( GetPar( "EventoId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV6EventoId", StringUtil.LTrimStr( (decimal)(AV6EventoId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6EventoId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6EventoId, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Evento Sectores WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("eventosectoreswc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6EventoId,4,0))}, new string[] {"EventoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6EventoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6EventoId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vEVENTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EventoId), 4, 0, ".", "")));
      ...
      {
         return "EventoSectoresWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Evento Sectores WC" ;
      }
      ...
      protected void WB0O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "eventosectoreswc.aspx");
            }
            /* Div Control */
         ...
         if ( wbEnd == 15 )
         {
            ...
            GxWebStd.gx_label_element( context, edtEventoId_Internalname, "Evento Id", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 24,'" + sPrefix + "',false,'" + sGXsfl_15_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtEventoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A3EventoId), 4, 0, ".", "")), StringUtil.LTrim( ((edtEventoId_Enabled!=0) ? context.localUtil.Format( (decimal)(A3EventoId), "ZZZ9") : context.localUtil.Format( (decimal)(A3EventoId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,24);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEventoId_Jsonclick, 0, "Attribute", "", "", "", "", edtEventoId_Visible, edtEventoId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_EventoSectoresWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0O2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Evento Sectores WC", 0) ;
            context.wjLoc = "";
      ...
      protected void RF0O2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000O2 */
            pr_default.execute(0, new Object[] {AV6EventoId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_15_idx = 1;
            sGXsfl_15_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_15_idx), 4, 0), 4, "0");
            SubsflControlProps_152( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A10SectorNombre = H000O2_A10SectorNombre[0];
               A21SectorPrecio = H000O2_A21SectorPrecio[0];
               A20SectorCapacidad = H000O2_A20SectorCapacidad[0];
               A3EventoId = H000O2_A3EventoId[0];
               AssignAttri(sPrefix, false, "A3EventoId", StringUtil.LTrimStr( (decimal)(A3EventoId), 4, 0));
               A5SectorId = H000O2_A5SectorId[0];
               A10SectorNombre = H000O2_A10SectorNombre[0];
               A21SectorPrecio = H000O2_A21SectorPrecio[0];
               A20SectorCapacidad = H000O2_A20SectorCapacidad[0];
      ...
      {
         /* Using cursor H000O3 */
         pr_default.execute(1, new Object[] {AV6EventoId});
      ...
      protected void STRUP0O0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6EventoId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EventoId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E110O2( )
      {
         ...
         subGrid_Rows = 10;
         GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         edtEventoId_Visible = 0;
         AssignProp(sPrefix, false, edtEventoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtEventoId_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "EventoId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6EventoId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6EventoId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6EventoId", StringUtil.LTrimStr( (decimal)(AV6EventoId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6EventoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "eventosectoreswc", GetJustCreated( ));
         ...
         {
            AV6EventoId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6EventoId", StringUtil.LTrimStr( (decimal)(AV6EventoId), 4, 0));
         }
         wcpOAV6EventoId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EventoId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV6EventoId != wcpOAV6EventoId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6EventoId = AV6EventoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6EventoId = cgiGet( sPrefix+"AV6EventoId_CTRL");
         if ( StringUtil.Len( sCtrlAV6EventoId) > 0 )
         {
            AV6EventoId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6EventoId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6EventoId", StringUtil.LTrimStr( (decimal)(AV6EventoId), 4, 0));
         }
         else
         {
            AV6EventoId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6EventoId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6EventoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EventoId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6EventoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6EventoId_CTRL", StringUtil.RTrim( sCtrlAV6EventoId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219512390", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("eventosectoreswc.js", "?202481219512390", false, true);
         }
      ...
      {
         edtSectorId_Internalname = sPrefix+"SECTORID_"+sGXsfl_15_idx;
         edtSectorCapacidad_Internalname = sPrefix+"SECTORCAPACIDAD_"+sGXsfl_15_idx;
         edtSectorPrecio_Internalname = sPrefix+"SECTORPRECIO_"+sGXsfl_15_idx;
         edtSectorNombre_Internalname = sPrefix+"SECTORNOMBRE_"+sGXsfl_15_idx;
         edtSectorCupoActual_Internalname = sPrefix+"SECTORCUPOACTUAL_"+sGXsfl_15_idx;
      }

      protected void SubsflControlProps_fel_152( )
      {
         edtSectorId_Internalname = sPrefix+"SECTORID_"+sGXsfl_15_fel_idx;
         edtSectorCapacidad_Internalname = sPrefix+"SECTORCAPACIDAD_"+sGXsfl_15_fel_idx;
         edtSectorPrecio_Internalname = sPrefix+"SECTORPRECIO_"+sGXsfl_15_fel_idx;
         edtSectorNombre_Internalname = sPrefix+"SECTORNOMBRE_"+sGXsfl_15_fel_idx;
         edtSectorCupoActual_Internalname = sPrefix+"SECTORCUPOACTUAL_"+sGXsfl_15_fel_idx;
      }
      ...
      protected void sendrow_152( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSectorCupoActual_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A25SectorCupoActual), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A25SectorCupoActual), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSectorCupoActual_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)15,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
      ...
      protected void StartGridControl15( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Cupo Actual") ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A25SectorCupoActual), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      protected void init_default_properties( )
      {
         ...
         edtSectorCupoActual_Internalname = sPrefix+"SECTORCUPOACTUAL";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6EventoId","fld":"vEVENTOID","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E120O2","iparms":[{"av":"A5SectorId","fld":"SECTORID","pic":"ZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtSectorNombre_Link","ctrl":"SECTORNOMBRE","prop":"Link"}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6EventoId","fld":"vEVENTOID","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6EventoId","fld":"vEVENTOID","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6EventoId","fld":"vEVENTOID","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6EventoId","fld":"vEVENTOID","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         ...
         setEventMetadata("NULL","""{"handler":"Valid_Sectorcupoactual","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         A10SectorNombre = "";
         H000O2_A10SectorNombre = new string[] {""} ;
         H000O2_A21SectorPrecio = new short[1] ;
         H000O2_A20SectorCapacidad = new short[1] ;
         H000O2_A3EventoId = new short[1] ;
         H000O2_A5SectorId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.eventosectoreswc__default(),
            new Object[][] {
                new Object[] {
               H000O2_A10SectorNombre, H000O2_A21SectorPrecio, H000O2_A20SectorCapacidad, H000O2_A3EventoId, H000O2_A5SectorId
               }
               , new Object[] {
      ...
      private short AV6EventoId ;
      private short wcpOAV6EventoId ;
      ...
      private int edtEventoId_Visible ;
      ...
      private string sCtrlAV6EventoId ;
      ...
      private string[] H000O2_A10SectorNombre ;
      private short[] H000O2_A21SectorPrecio ;
      private short[] H000O2_A20SectorCapacidad ;
      private short[] H000O2_A3EventoId ;
      private short[] H000O2_A5SectorId ;
   ...
   public class eventosectoreswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6EventoId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000O2", "SELECT T2.[SectorNombre], T2.[SectorPrecio], T2.[SectorCapacidad], T1.[EventoId], T1.[SectorId] FROM ([EventoSector] T1 INNER JOIN [Sector] T2 ON T2.[SectorId] = T1.[SectorId]) WHERE T1.[EventoId] = @AV6EventoId ORDER BY T1.[EventoId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000O2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000O3", "SELECT COUNT(*) FROM ([EventoSector] T1 INNER JOIN [Sector] T2 ON T2.[SectorId] = T1.[SectorId]) WHERE T1.[EventoId] = @AV6EventoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000O3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
