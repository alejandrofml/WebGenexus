...
namespace GeneXus.Programs.general.security {
   public class notauthorized : GXDataArea
   {
      ...
      protected void wb_table1_3_032e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table2_12_032e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table2_12_032( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table1_3_032( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219513431", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("general/security/notauthorized.js", "?202481219513431", false, true);
