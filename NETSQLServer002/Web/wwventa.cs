...
namespace GeneXus.Programs {
   public class wwventa : GXDataArea
   {
      public wwventa( )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV15VentaHoraFecha = context.localUtil.ParseDTimeParm( GetPar( "VentaHoraFecha"));
         AV14Update = GetPar( "Update");
         AV6Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV15VentaHoraFecha, AV14Update, AV6Delete) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vVENTAHORAFECHA", context.localUtil.TToC( AV15VentaHoraFecha, 10, 8, 1, 2, "/", ":", " "));
         /* Send saved values. */
      ...
      protected void WB0J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Ventas", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWVenta.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWVenta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavVentahorafecha_Internalname, "Venta Hora Fecha", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            context.WriteHtmlText( "<div id=\""+edtavVentahorafecha_Internalname+"_dp_container\" class=\"dp_container\" style=\"white-space:nowrap;display:inline;\">") ;
            GxWebStd.gx_single_line_edit( context, edtavVentahorafecha_Internalname, context.localUtil.TToC( AV15VentaHoraFecha, 10, 8, 1, 2, "/", ":", " "), context.localUtil.Format( AV15VentaHoraFecha, "99/99/99 99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'MDY',5,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'MDY',5,12,'eng',false,0);"+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Hora Fecha", edtavVentahorafecha_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavVentahorafecha_Enabled, 0, "text", "", 17, "chr", 1, "row", 17, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WWVenta.htm");
            GxWebStd.gx_bitmap( context, edtavVentahorafecha_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavVentahorafecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WWVenta.htm");
         ...
         if ( wbEnd == 27 )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttVolver_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Volver", bttVolver_Jsonclick, 7, "Volver", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110j1_client"+"'", TempTags, "", 2, "HLP_WWVenta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0J2( )
      {
         ...
         Form.Meta.addItem("description", "Work With Venta", 0) ;
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A8VentaId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtVentaId_Internalname), ".", ","), 18, MidpointRounding.ToEven));
                              A23VentaHoraFecha = context.localUtil.CToT( cgiGet( edtVentaHoraFecha_Internalname), 0);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Ventahorafecha Changed */
                                       if ( context.localUtil.CToT( cgiGet( "GXH_vVENTAHORAFECHA"), 0) != AV15VentaHoraFecha )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0J2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavVentahorafecha_Internalname;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_VENTAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A8VentaId), "ZZZ9"), context));
      ...
      protected void RF0J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000J2 */
            pr_default.execute(0, new Object[] {AV15VentaHoraFecha, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A3EventoId = H000J2_A3EventoId[0];
               A5SectorId = H000J2_A5SectorId[0];
               A23VentaHoraFecha = H000J2_A23VentaHoraFecha[0];
               A8VentaId = H000J2_A8VentaId[0];
               /* Execute user event: Grid.Load */
               E150J2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_VENTAID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A8VentaId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H000J3 */
         pr_default.execute(1, new Object[] {AV15VentaHoraFecha});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV15VentaHoraFecha = context.localUtil.CToT( GridState.FilterValues("Ventahorafecha"), 1);
            AssignAttri("", false, "AV15VentaHoraFecha", context.localUtil.TToC( AV15VentaHoraFecha, 8, 5, 1, 2, "/", ":", " "));
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("VentaHoraFecha", context.localUtil.TToC( AV15VentaHoraFecha, 8, 5, 1, 2, "/", ":", " "));
      }
      ...
      protected void STRUP0J0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtavVentahorafecha_Internalname), 1, 1) == 0 )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_baddatetime", new   object[]  {"Venta Hora Fecha"}), 1, "vVENTAHORAFECHA");
               GX_FocusControl = edtavVentahorafecha_Internalname;
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV15VentaHoraFecha = (DateTime)(DateTime.MinValue);
               AssignAttri("", false, "AV15VentaHoraFecha", context.localUtil.TToC( AV15VentaHoraFecha, 8, 5, 1, 2, "/", ":", " "));
            }
            else
            {
               AV15VentaHoraFecha = context.localUtil.CToT( cgiGet( edtavVentahorafecha_Internalname));
               AssignAttri("", false, "AV15VentaHoraFecha", context.localUtil.TToC( AV15VentaHoraFecha, 8, 5, 1, 2, "/", ":", " "));
            }
            ...
            if ( context.localUtil.CToT( cgiGet( "GXH_vVENTAHORAFECHA")) != AV15VentaHoraFecha )
            {
               GRID_nFirstRecordOnPage = 0;
            }
         }
      ...
      private void E150J2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("venta.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A8VentaId,4,0))}, new string[] {"Mode","VentaId"}) ;
         edtavDelete_Link = formatLink("venta.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A8VentaId,4,0))}, new string[] {"Mode","VentaId"}) ;
         edtVentaHoraFecha_Link = formatLink("viewventa.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A8VentaId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"VentaId","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 27;
      ...
      protected void S112( )
      {
         ...
         AV12TrnContext.gxTpr_Transactionname = "Venta";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219513695", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwventa.js", "?202481219513695", false, true);
         }
      ...
      {
         edtVentaId_Internalname = "VENTAID_"+sGXsfl_27_idx;
         edtVentaHoraFecha_Internalname = "VENTAHORAFECHA_"+sGXsfl_27_idx;
      ...
      {
         edtVentaId_Internalname = "VENTAID_"+sGXsfl_27_fel_idx;
         edtVentaHoraFecha_Internalname = "VENTAHORAFECHA_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtVentaId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A8VentaId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A8VentaId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtVentaId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtVentaHoraFecha_Internalname,context.localUtil.TToC( A23VentaHoraFecha, 10, 8, 1, 2, "/", ":", " "),context.localUtil.Format( A23VentaHoraFecha, "99/99/99 99:99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtVentaHoraFecha_Link,(string)"",(string)"",(string)"",(string)edtVentaHoraFecha_Jsonclick,(short)0,(string)"attribute-description",(string)"",(string)ROClassString,(string)"column",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)17,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A8VentaId), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.TToC( A23VentaHoraFecha, 10, 8, 1, 2, "/", ":", " ")));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtVentaHoraFecha_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavVentahorafecha_Internalname = "vVENTAHORAFECHA";
         divTabletop_Internalname = "TABLETOP";
         edtVentaId_Internalname = "VENTAID";
         edtVentaHoraFecha_Internalname = "VENTAHORAFECHA";
      ...
      public override void initialize_properties( )
      {
         ...
         edtVentaHoraFecha_Enabled = 0;
         edtVentaId_Enabled = 0;
         edtavVentahorafecha_Jsonclick = "";
         edtavVentahorafecha_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = "Work With Venta";
         subGrid_Rows = 10;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV15VentaHoraFecha","fld":"vVENTAHORAFECHA","pic":"99/99/99 99:99"},{"av":"AV14Update","fld":"vUPDATE"},{"av":"AV6Delete","fld":"vDELETE"}]}""");
         setEventMetadata("'VOLVER'","""{"handler":"E110J1","iparms":[]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E150J2","iparms":[{"av":"A8VentaId","fld":"VENTAID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtVentaHoraFecha_Link","ctrl":"VENTAHORAFECHA","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E120J2","iparms":[{"av":"A8VentaId","fld":"VENTAID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV15VentaHoraFecha","fld":"vVENTAHORAFECHA","pic":"99/99/99 99:99"},{"av":"AV14Update","fld":"vUPDATE"},{"av":"AV6Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV15VentaHoraFecha","fld":"vVENTAHORAFECHA","pic":"99/99/99 99:99"},{"av":"AV14Update","fld":"vUPDATE"},{"av":"AV6Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV15VentaHoraFecha","fld":"vVENTAHORAFECHA","pic":"99/99/99 99:99"},{"av":"AV14Update","fld":"vUPDATE"},{"av":"AV6Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV15VentaHoraFecha","fld":"vVENTAHORAFECHA","pic":"99/99/99 99:99"},{"av":"AV14Update","fld":"vUPDATE"},{"av":"AV6Delete","fld":"vDELETE"}]}""");
         setEventMetadata("VALIDV_VENTAHORAFECHA","""{"handler":"Validv_Ventahorafecha","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         H000J2_A3EventoId = new short[1] ;
         H000J2_A5SectorId = new short[1] ;
         H000J2_A23VentaHoraFecha = new DateTime[] {DateTime.MinValue} ;
         H000J2_A8VentaId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwventa__default(),
            new Object[][] {
                new Object[] {
               H000J2_A3EventoId, H000J2_A5SectorId, H000J2_A23VentaHoraFecha, H000J2_A8VentaId
               }
               , new Object[] {
      ...
      private int edtavVentahorafecha_Enabled ;
      ...
      private string edtavVentahorafecha_Internalname ;
      private string edtavVentahorafecha_Jsonclick ;
      ...
      private string edtVentaHoraFecha_Link ;
      ...
      private DateTime AV15VentaHoraFecha ;
      ...
      private short[] H000J2_A3EventoId ;
      private short[] H000J2_A5SectorId ;
      private DateTime[] H000J2_A23VentaHoraFecha ;
      private short[] H000J2_A8VentaId ;
   ...
   public class wwventa__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             DateTime A23VentaHoraFecha )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [EventoId], [SectorId], [VentaHoraFecha], [VentaId]";
         sFromString = " FROM [Venta]";
         sOrderString = "";
         if ( ! (DateTime.MinValue==AV15VentaHoraFecha) )
         {
            AddWhere(sWhereString, "([VentaHoraFecha] >= @AV15VentaHoraFecha)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [VentaHoraFecha]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000J2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] );
               case 1 :
                     return conditional_H000J3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV15VentaHoraFecha",GXType.DateTime,8,5) ,
