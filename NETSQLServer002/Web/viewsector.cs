...
namespace GeneXus.Programs {
   public class viewsector : GXDataArea
   {
      public viewsector( )
      {
      ...
      public viewsector( IGxContext context )
      {
      ...
      public void execute( short aP0_SectorId ,
                           string aP1_TabCode )
      {
         this.AV12SectorId = aP0_SectorId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12SectorId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12SectorId", StringUtil.LTrimStr( (decimal)(AV12SectorId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vSECTORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12SectorId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewsector.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12SectorId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"SectorId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vSECTORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12SectorId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vSECTORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12SectorId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewsector.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12SectorId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"SectorId","TabCode"})  ;
      }
      ...
      protected void WB0A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Sectores", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewSector.htm");
            ...
            GxWebStd.gx_label_element( context, edtSectorCapacidad_Internalname, "Capacidad", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtSectorCapacidad_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A20SectorCapacidad), 4, 0, ".", "")), StringUtil.LTrim( ((edtSectorCapacidad_Enabled!=0) ? context.localUtil.Format( (decimal)(A20SectorCapacidad), "ZZZ9") : context.localUtil.Format( (decimal)(A20SectorCapacidad), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSectorCapacidad_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtSectorCapacidad_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_ViewSector.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewSector.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSectores_title_Internalname, "Evento", "", "", lblSectores_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewSector.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
      ...
      protected void START0A2( )
      {
         ...
         Form.Meta.addItem("description", "View Sector", 0) ;
         context.wjLoc = "";
      ...
      protected void RF0A2( )
      {
         ...
         {
            /* Using cursor H000A2 */
            pr_default.execute(0, new Object[] {AV12SectorId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A5SectorId = H000A2_A5SectorId[0];
               A20SectorCapacidad = H000A2_A20SectorCapacidad[0];
      ...
      protected void STRUP0A0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12SectorId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vSECTORID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E110A2( )
      {
         ...
         AV14GXLvl7 = 0;
         /* Using cursor H000A3 */
         pr_default.execute(1, new Object[] {AV12SectorId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A5SectorId = H000A3_A5SectorId[0];
            A10SectorNombre = H000A3_A10SectorNombre[0];
            AV14GXLvl7 = 1;
            Form.Caption = A10SectorNombre;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwsector.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "SectorGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "sectorgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "SectorGeneral";
               WebComp_Generalwc_Component = "SectorGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12SectorId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12SectorId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12SectorId", StringUtil.LTrimStr( (decimal)(AV12SectorId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vSECTORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12SectorId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219513584", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewsector.js", "?202481219513584", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12SectorId","fld":"vSECTORID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H000A2_A5SectorId = new short[1] ;
         H000A2_A20SectorCapacidad = new short[1] ;
         H000A3_A5SectorId = new short[1] ;
         H000A3_A10SectorNombre = new string[] {""} ;
         A10SectorNombre = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewsector__default(),
            new Object[][] {
                new Object[] {
               H000A2_A5SectorId, H000A2_A20SectorCapacidad
               }
               , new Object[] {
               H000A3_A5SectorId, H000A3_A10SectorNombre
               }
            }
         );
      ...
      private short AV12SectorId ;
      private short wcpOAV12SectorId ;
      ...
      private short[] H000A2_A5SectorId ;
      private short[] H000A2_A20SectorCapacidad ;
      private short[] H000A3_A5SectorId ;
      private string[] H000A3_A10SectorNombre ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class viewsector__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12SectorId",GXType.Int16,4,0)
          };
          Object[] prmH000A3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000A2", "SELECT [SectorId], [SectorCapacidad] FROM [Sector] WHERE [SectorId] = @AV12SectorId ORDER BY [SectorId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000A3", "SELECT [SectorId], [SectorNombre] FROM [Sector] WHERE [SectorId] = @AV12SectorId ORDER BY [SectorId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
