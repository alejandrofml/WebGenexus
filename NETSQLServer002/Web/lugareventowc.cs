...
namespace GeneXus.Programs {
   public class lugareventowc : GXWebComponent
   {
      public lugareventowc( )
      {
      ...
      public lugareventowc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Lugar Evento WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("lugareventowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6LugarId,4,0))}, new string[] {"LugarId"}) +"\">") ;
      ...
      {
         return "LugarEventoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Lugar Evento WC" ;
      }
      ...
      protected void WB0T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "lugareventowc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_LugarEventoWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtLugarId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A4LugarId), 4, 0, ".", "")), StringUtil.LTrim( ((edtLugarId_Enabled!=0) ? context.localUtil.Format( (decimal)(A4LugarId), "ZZZ9") : context.localUtil.Format( (decimal)(A4LugarId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,31);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLugarId_Jsonclick, 0, "Attribute", "", "", "", "", edtLugarId_Visible, edtLugarId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_LugarEventoWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0T2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Lugar Evento WC", 0) ;
            context.wjLoc = "";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "lugareventowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219512820", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("lugareventowc.js", "?202481219512820", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E130T2","iparms":[{"av":"A3EventoId","fld":"EVENTOID","pic":"ZZZ9","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E110T2","iparms":[{"av":"A3EventoId","fld":"EVENTOID","pic":"ZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         H000T2_A4LugarId = new short[1] ;
         H000T2_A1EspectaculoId = new short[1] ;
         H000T2_A17EventoHoraFecha = new DateTime[] {DateTime.MinValue} ;
         H000T2_A3EventoId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.lugareventowc__default(),
            new Object[][] {
                new Object[] {
               H000T2_A4LugarId, H000T2_A1EspectaculoId, H000T2_A17EventoHoraFecha, H000T2_A3EventoId
               }
               , new Object[] {
      ...
      private short[] H000T2_A4LugarId ;
      private short[] H000T2_A1EspectaculoId ;
      private DateTime[] H000T2_A17EventoHoraFecha ;
      private short[] H000T2_A3EventoId ;
   ...
   public class lugareventowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000T2", "SELECT [LugarId], [EspectaculoId], [EventoHoraFecha], [EventoId] FROM [Evento] WHERE [LugarId] = @AV6LugarId ORDER BY [LugarId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000T2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000T3", "SELECT COUNT(*) FROM [Evento] WHERE [LugarId] = @AV6LugarId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000T3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
