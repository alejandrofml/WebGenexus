...
namespace GeneXus.Programs {
   public class viewtipoespectaculo : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12TipoEspectaculoId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("TipoEspectaculoNombre", StringUtil.RTrim( context.localUtil.Format( A12TipoEspectaculoNombre, "")));
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Tipo de Espectáculo", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewTipoEspectaculo.htm");
            ...
            GxWebStd.gx_label_element( context, edtTipoEspectaculoNombre_Internalname, "Espectaculo Nombre", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtTipoEspectaculoNombre_Internalname, A12TipoEspectaculoNombre, StringUtil.RTrim( context.localUtil.Format( A12TipoEspectaculoNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTipoEspectaculoNombre_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtTipoEspectaculoNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_ViewTipoEspectaculo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      {
         /* GeneXus formulas. */
         AV13Pgmname = "ViewTipoEspectaculo";
      }
      ...
      protected void RF0B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A2TipoEspectaculoId = H000B2_A2TipoEspectaculoId[0];
               A12TipoEspectaculoNombre = H000B2_A12TipoEspectaculoNombre[0];
      ...
      protected void STRUP0B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12TipoEspectaculoId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vTIPOESPECTACULOID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E110B2( )
      {
         ...
         {
            A2TipoEspectaculoId = H000B3_A2TipoEspectaculoId[0];
            A12TipoEspectaculoNombre = H000B3_A12TipoEspectaculoNombre[0];
            AssignAttri("", false, "A12TipoEspectaculoNombre", A12TipoEspectaculoNombre);
            AV14GXLvl7 = 1;
            Form.Caption = A12TipoEspectaculoNombre;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12TipoEspectaculoId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Espectaculo") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Espectaculowc_Component) != 0 )
            {
               ...
               WebComp_Espectaculowc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12TipoEspectaculoId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219513553", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewtipoespectaculo.js", "?202481219513553", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12TipoEspectaculoId","fld":"vTIPOESPECTACULOID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A12TipoEspectaculoNombre","fld":"TIPOESPECTACULONOMBRE"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H000B2_A2TipoEspectaculoId = new short[1] ;
         H000B2_A12TipoEspectaculoNombre = new string[] {""} ;
         hsh = "";
         H000B3_A2TipoEspectaculoId = new short[1] ;
         H000B3_A12TipoEspectaculoNombre = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewtipoespectaculo__default(),
            new Object[][] {
                new Object[] {
               H000B2_A2TipoEspectaculoId, H000B2_A12TipoEspectaculoNombre
               }
               , new Object[] {
               H000B3_A2TipoEspectaculoId, H000B3_A12TipoEspectaculoNombre
               }
            }
         );
      ...
      private short[] H000B2_A2TipoEspectaculoId ;
      private string[] H000B2_A12TipoEspectaculoNombre ;
      private short[] H000B3_A2TipoEspectaculoId ;
      private string[] H000B3_A12TipoEspectaculoNombre ;
   ...
   public class viewtipoespectaculo__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000B2", "SELECT [TipoEspectaculoId], [TipoEspectaculoNombre] FROM [TipoEspectaculo] WHERE [TipoEspectaculoId] = @AV12TipoEspectaculoId ORDER BY [TipoEspectaculoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000B3", "SELECT [TipoEspectaculoId], [TipoEspectaculoNombre] FROM [TipoEspectaculo] WHERE [TipoEspectaculoId] = @AV12TipoEspectaculoId ORDER BY [TipoEspectaculoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
