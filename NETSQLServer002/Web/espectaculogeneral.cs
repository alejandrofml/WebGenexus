   ...
   public class espectaculogeneral : GXWebComponent
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV11Pgmname = "EspectaculoGeneral";
               WS0K2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110k1_client"+"'", TempTags, "", 2, "HLP_EspectaculoGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120k1_client"+"'", TempTags, "", 2, "HLP_EspectaculoGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtEspectaculoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EspectaculoId), 4, 0, ".", "")), StringUtil.LTrim( ((edtEspectaculoId_Enabled!=0) ? context.localUtil.Format( (decimal)(A1EspectaculoId), "ZZZ9") : context.localUtil.Format( (decimal)(A1EspectaculoId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,18);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEspectaculoId_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtEspectaculoId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_EspectaculoGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtEspectaculoNombre_Internalname, A14EspectaculoNombre, StringUtil.RTrim( context.localUtil.Format( A14EspectaculoNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,23);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEspectaculoNombre_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtEspectaculoNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_EspectaculoGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtEspectaculoDescripcion_Internalname, "Descripcion", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Multiple line edit */
            ...
            ClassString = "ReadonlyAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtEspectaculoDescripcion_Internalname, A15EspectaculoDescripcion, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,28);\"", 0, 1, edtEspectaculoDescripcion_Enabled, 0, 80, "chr", 7, "row", 0, StyleString, ClassString, "", "", "500", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_EspectaculoGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtTipoEspectaculoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A2TipoEspectaculoId), 4, 0, ".", "")), StringUtil.LTrim( ((edtTipoEspectaculoId_Enabled!=0) ? context.localUtil.Format( (decimal)(A2TipoEspectaculoId), "ZZZ9") : context.localUtil.Format( (decimal)(A2TipoEspectaculoId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,33);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTipoEspectaculoId_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtTipoEspectaculoId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_EspectaculoGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgEspectaculoImagen_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 0, "", "", 0, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, A16EspectaculoImagen_IsBlob, true, context.GetImageSrcSet( sImgUrl), "HLP_EspectaculoGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40000EspectaculoImagen_GXI = H000K2_A40000EspectaculoImagen_GXI[0];
               AssignProp(sPrefix, false, imgEspectaculoImagen_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A16EspectaculoImagen)) ? A40000EspectaculoImagen_GXI : context.convertURL( context.PathToRelativeUrl( A16EspectaculoImagen))), true);
               AssignProp(sPrefix, false, imgEspectaculoImagen_Internalname, "SrcSet", context.GetImageSrcSet( A16EspectaculoImagen), true);
               A2TipoEspectaculoId = H000K2_A2TipoEspectaculoId[0];
               AssignAttri(sPrefix, false, "A2TipoEspectaculoId", StringUtil.LTrimStr( (decimal)(A2TipoEspectaculoId), 4, 0));
               A15EspectaculoDescripcion = H000K2_A15EspectaculoDescripcion[0];
               AssignAttri(sPrefix, false, "A15EspectaculoDescripcion", A15EspectaculoDescripcion);
               A14EspectaculoNombre = H000K2_A14EspectaculoNombre[0];
               AssignAttri(sPrefix, false, "A14EspectaculoNombre", A14EspectaculoNombre);
               A16EspectaculoImagen = H000K2_A16EspectaculoImagen[0];
               AssignAttri(sPrefix, false, "A16EspectaculoImagen", A16EspectaculoImagen);
               AssignProp(sPrefix, false, imgEspectaculoImagen_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A16EspectaculoImagen)) ? A40000EspectaculoImagen_GXI : context.convertURL( context.PathToRelativeUrl( A16EspectaculoImagen))), true);
               AssignProp(sPrefix, false, imgEspectaculoImagen_Internalname, "SrcSet", context.GetImageSrcSet( A16EspectaculoImagen), true);
               /* Execute user event: Load */
               E140K2 ();
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtEspectaculoNombre_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEspectaculoNombre_Enabled), 5, 0), true);
         edtEspectaculoDescripcion_Enabled = 0;
         AssignProp(sPrefix, false, edtEspectaculoDescripcion_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEspectaculoDescripcion_Enabled), 5, 0), true);
         ...
         AssignProp(sPrefix, false, imgEspectaculoImagen_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(imgEspectaculoImagen_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP0K0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA1EspectaculoId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA1EspectaculoId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            A1EspectaculoId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA1EspectaculoId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A1EspectaculoId", StringUtil.LTrimStr( (decimal)(A1EspectaculoId), 4, 0));
         }
         else
         {
            A1EspectaculoId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A1EspectaculoId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219512828", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("espectaculogeneral.js", "?202481219512828", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A1EspectaculoId","fld":"ESPECTACULOID","pic":"ZZZ9"}]}""");
         setEventMetadata("'DOUPDATE'","""{"handler":"E110K1","iparms":[{"av":"A1EspectaculoId","fld":"ESPECTACULOID","pic":"ZZZ9"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E120K1","iparms":[{"av":"A1EspectaculoId","fld":"ESPECTACULOID","pic":"ZZZ9"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H000K2_A40000EspectaculoImagen_GXI = new string[] {""} ;
         H000K2_A2TipoEspectaculoId = new short[1] ;
         H000K2_A15EspectaculoDescripcion = new string[] {""} ;
         H000K2_A14EspectaculoNombre = new string[] {""} ;
         H000K2_A16EspectaculoImagen = new string[] {""} ;
         AV7TrnContext = new GeneXus.Programs.general.ui.SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.espectaculogeneral__default(),
            new Object[][] {
                new Object[] {
               H000K2_A1EspectaculoId, H000K2_A40000EspectaculoImagen_GXI, H000K2_A2TipoEspectaculoId, H000K2_A15EspectaculoDescripcion, H000K2_A14EspectaculoNombre, H000K2_A16EspectaculoImagen
               }
            }
         );
         AV11Pgmname = "EspectaculoGeneral";
      ...
      private string[] H000K2_A40000EspectaculoImagen_GXI ;
      private short[] H000K2_A2TipoEspectaculoId ;
      private string[] H000K2_A15EspectaculoDescripcion ;
      private string[] H000K2_A14EspectaculoNombre ;
      private string[] H000K2_A16EspectaculoImagen ;
   ...
   public class espectaculogeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000K2", "SELECT [EspectaculoId], [EspectaculoImagen_GXI], [TipoEspectaculoId], [EspectaculoDescripcion], [EspectaculoNombre], [EspectaculoImagen] FROM [Espectaculo] WHERE [EspectaculoId] = @EspectaculoId ORDER BY [EspectaculoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
