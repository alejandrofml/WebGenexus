...
namespace GeneXus.Programs {
   public class sectorsectoreswc : GXWebComponent
   {
      public sectorsectoreswc( )
      {
      ...
      public sectorsectoreswc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6SectorId = (short)(Math.Round(NumberUtil.Val( GetPar( "SectorId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV6SectorId", StringUtil.LTrimStr( (decimal)(AV6SectorId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6SectorId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Sector Sectores WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("sectorsectoreswc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6SectorId,4,0))}, new string[] {"SectorId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6SectorId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6SectorId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vSECTORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SectorId), 4, 0, ".", "")));
      ...
      {
         return "SectorSectoresWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Sector Sectores WC" ;
      }
      ...
      protected void WB140( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "sectorsectoreswc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_SectorSectoresWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtSectorId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A5SectorId), 4, 0, ".", "")), StringUtil.LTrim( ((edtSectorId_Enabled!=0) ? context.localUtil.Format( (decimal)(A5SectorId), "ZZZ9") : context.localUtil.Format( (decimal)(A5SectorId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,32);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSectorId_Jsonclick, 0, "Attribute", "", "", "", "", edtSectorId_Visible, edtSectorId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_SectorSectoresWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START142( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Sector Sectores WC", 0) ;
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_EVENTOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A3EventoId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"EVENTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A3EventoId), 4, 0, ".", "")));
      }
      ...
      protected void RF142( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A5SectorId = H00142_A5SectorId[0];
               AssignAttri(sPrefix, false, "A5SectorId", StringUtil.LTrimStr( (decimal)(A5SectorId), 4, 0));
               A4LugarId = H00142_A4LugarId[0];
               A1EspectaculoId = H00142_A1EspectaculoId[0];
               A17EventoHoraFecha = H00142_A17EventoHoraFecha[0];
               A3EventoId = H00142_A3EventoId[0];
               A4LugarId = H00142_A4LugarId[0];
               A1EspectaculoId = H00142_A1EspectaculoId[0];
               A17EventoHoraFecha = H00142_A17EventoHoraFecha[0];
               /* Execute user event: Grid.Load */
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_EVENTOID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A3EventoId), "ZZZ9"), context));
      }
      ...
      protected void STRUP140( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6SectorId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SectorId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Evento";
         ...
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6SectorId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6SectorId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6SectorId", StringUtil.LTrimStr( (decimal)(AV6SectorId), 4, 0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "sectorsectoreswc", GetJustCreated( ));
         ...
         {
            AV6SectorId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6SectorId", StringUtil.LTrimStr( (decimal)(AV6SectorId), 4, 0));
         }
         wcpOAV6SectorId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SectorId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6SectorId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6SectorId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6SectorId", StringUtil.LTrimStr( (decimal)(AV6SectorId), 4, 0));
         }
         else
         {
            AV6SectorId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6SectorId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6SectorId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SectorId), 4, 0, ".", "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481219512872", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("sectorsectoreswc.js", "?202481219512872", false, true);
         }
      ...
      {
         edtEventoId_Internalname = sPrefix+"EVENTOID_"+sGXsfl_22_idx;
         edtEventoHoraFecha_Internalname = sPrefix+"EVENTOHORAFECHA_"+sGXsfl_22_idx;
         edtEspectaculoId_Internalname = sPrefix+"ESPECTACULOID_"+sGXsfl_22_idx;
         edtLugarId_Internalname = sPrefix+"LUGARID_"+sGXsfl_22_idx;
      ...
      {
         edtEventoId_Internalname = sPrefix+"EVENTOID_"+sGXsfl_22_fel_idx;
         edtEventoHoraFecha_Internalname = sPrefix+"EVENTOHORAFECHA_"+sGXsfl_22_fel_idx;
         edtEspectaculoId_Internalname = sPrefix+"ESPECTACULOID_"+sGXsfl_22_fel_idx;
         edtLugarId_Internalname = sPrefix+"LUGARID_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEventoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A3EventoId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A3EventoId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEventoId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEspectaculoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EspectaculoId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A1EspectaculoId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEspectaculoId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtLugarId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A4LugarId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A4LugarId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtLugarId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtEventoHoraFecha_Internalname = sPrefix+"EVENTOHORAFECHA";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SectorId","fld":"vSECTORID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E13142","iparms":[{"av":"A3EventoId","fld":"EVENTOID","pic":"ZZZ9","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E11142","iparms":[{"av":"A3EventoId","fld":"EVENTOID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SectorId","fld":"vSECTORID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SectorId","fld":"vSECTORID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SectorId","fld":"vSECTORID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SectorId","fld":"vSECTORID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H00142_A5SectorId = new short[1] ;
         H00142_A4LugarId = new short[1] ;
         H00142_A1EspectaculoId = new short[1] ;
         H00142_A17EventoHoraFecha = new DateTime[] {DateTime.MinValue} ;
         H00142_A3EventoId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sectorsectoreswc__default(),
            new Object[][] {
                new Object[] {
               H00142_A5SectorId, H00142_A4LugarId, H00142_A1EspectaculoId, H00142_A17EventoHoraFecha, H00142_A3EventoId
               }
               , new Object[] {
      ...
      private short AV6SectorId ;
      private short wcpOAV6SectorId ;
      ...
      private short[] H00142_A5SectorId ;
      private short[] H00142_A4LugarId ;
      private short[] H00142_A1EspectaculoId ;
      private DateTime[] H00142_A17EventoHoraFecha ;
      private short[] H00142_A3EventoId ;
   ...
   public class sectorsectoreswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6SectorId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00142", "SELECT T1.[SectorId], T2.[LugarId], T2.[EspectaculoId], T2.[EventoHoraFecha], T1.[EventoId] FROM ([EventoSector] T1 INNER JOIN [Evento] T2 ON T2.[EventoId] = T1.[EventoId]) WHERE T1.[SectorId] = @AV6SectorId ORDER BY T1.[SectorId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00142,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00143", "SELECT COUNT(*) FROM ([EventoSector] T1 INNER JOIN [Evento] T2 ON T2.[EventoId] = T1.[EventoId]) WHERE T1.[SectorId] = @AV6SectorId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00143,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
